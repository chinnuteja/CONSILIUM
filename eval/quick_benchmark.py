"""
Quick 10-case benchmark on Pro for fast iteration.
...
if __name__ == "__main__":
    print("=" * 60)
    print("CONSILIUM Quick Benchmark: 10 cases, Pro, seed=42")
    print("=" * 60)
    start = time.time()
    result = run_benchmark(consilium_get_differential, n=10, label="quick", seed=42)
